...
def band_returner_landsat_5(show_list=False):
    """
...
def ndmi_calc_landsat_5(prefix=None, show_flag=False):
    """
    ...
    band_dict = band_returner_landsat_5()
    ...
    if band_dict:
        ...
        ndmi_image = open('./{}_ndmi_landsat_5.tiff'.format(prefix), 'w', driver='GTiff',
        ...
        if show_flag:
            ndmi = open('{}_ndmi_landsat_5.tiff'.format(prefix))
            show(ndmi, cmap='Blues')


def ndvi_calc_landsat_5(prefix=None, show_flag=False):
    """
    ...
    if band_dict:
        ...
        ndvi_image = open('./{}_ndvi_landsat_5.tiff'.format(prefix), 'w', driver='GTiff',
                          width=band4.width, height=band4.height,
                          count=1,
                          crs=band4.crs,
                          transform=band4.transform,
        ...
        if show_flag:
            ndvi = open('{}_ndvi_landsat_5.tiff'.format(prefix))
            show(ndvi, cmap='Greens')


def savi_calc_landsat_5(prefix=None, show_flag=False):
    """
    ...
    if band_dict:
        ...
        savi_image = open('./{}_savi_landsat_5.tiff'.format(prefix), 'w', driver='GTiff',
                          width=band4.width, height=band4.height,
                          count=1,
                          crs=band4.crs,
                          transform=band4.transform,
        ...
        if show_flag:
            savi = open('{}_savi_landsat_5.tiff'.format(prefix))
            show(savi, cmap='Greens')


def msavi_calc_landsat_5(prefix=None, show_flag=False):
    """
    ...
    if band_dict:
        ...
        msavi_image = open('./{}_msavi_landsat_5.tiff'.format(prefix), 'w', driver='GTiff',
                           width=band4.width, height=band4.height,
                           count=1,
                           crs=band4.crs,
                           transform=band4.transform,
        ...
        if show_flag:
            msavi = open('{}_msavi_landsat_5.tiff'.format(prefix))
            show(msavi, cmap='Greens')


def ndwi_calc_landsat_5(prefix=None, show_flag=False):
    """
    ...
    if band_dict:
        ...
        ndwi_image = open('./{}_ndwi_landsat_5.tiff'.format(prefix), 'w', driver='GTiff',
                          width=band4.width, height=band4.height,
                          count=1,
                          crs=band4.crs,
                          transform=band4.transform,
        ...
        if show_flag:
            ndwi = open('{}_ndwi_landsat_5.tiff'.format(prefix))
            show(ndwi, cmap='Greens')


def image_display_landsat_5():
    """
    Displays the images of landsat indices in a folder one at a time
    """
    ndmi = open('ndmi_landsat_5.tiff')
    ndvi = open('ndvi_landsat_5.tiff')
    savi = open('savi_landsat_5.tiff')
    msavi = open('msavi_landsat_5.tiff')
    ndwi = open('ndwi_landsat_5.tiff')
    show(ndmi, cmap='Blues')
    show(ndvi, cmap='Greens')
    show(savi, cmap='Greens')
    show(msavi, cmap='Greens')
...
def execute_landsat_5(prefix=None, show_individual=False, show_all=False, show_only=False, indices_requested=[False, False, False, True, False]):
    """
...
def landsat_5_test():
    """
    Test case for the index_calculator_landsat_5.py file
    """
    execute_landsat_5(show_individual=True)
    band_returner_landsat_5(show_list=True)
